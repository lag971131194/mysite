...
def rename_article_column(request):
    colum_name=request.POST["column_name"]
    colum_id=request.POST["column_id"]
    try:
        line=ArticleColumn.objects.get(id=colum_id)
        line.column=colum_name
        line.save()
        return HttpResponse("1")
    except:
